...
-- CreateEnum
CREATE TYPE "PartOrderStatus" AS ENUM ('DRAFT', 'ORDERED', 'SHIPPED', 'RECEIVED', 'ALREADY_IN_STOCK', 'INSTALLED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "PartOrder_workItemId_status_idx" ON "PartOrder"("workItemId", "status");
